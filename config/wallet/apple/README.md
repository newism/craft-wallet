...
This directory contains configuration files for Apple Wallet integration.
...
All properties on `AppleSettings` are automatically mapped to env vars with the `WALLET_APPLE_` prefix. See the [full settings reference](../../README.md#apple-wallet-settings) for the complete list.
