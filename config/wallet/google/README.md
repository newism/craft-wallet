...
This directory contains configuration files for Google Wallet integration.
...
All properties on `GoogleSettings` are automatically mapped to env vars with the `WALLET_GOOGLE_` prefix. See the [full settings reference](../../README.md#google-wallet-settings) for the complete list.
